...
define('PHEASEL_PAGES_DIR', realpath(PHEASEL_ROOT . "/pheasel/test/test-site").DIRECTORY_SEPARATOR); // force trailing slash, which makes things easier for us later

// pheasel's internal files cache
define('PHEASEL_FILES_CACHE', realpath(PHEASEL_ROOT . '/pheasel/test/cache/files.xml'));
